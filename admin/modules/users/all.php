          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Aranoz users</h6>
                  <p class="text-sm">Information about all users</p>
                </div>
            ...
            <div class="card-body px-0 py-0">
              <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                  ...
                  <label class="btn btn-white px-3 mb-0" for="btnradiotable3">Customer</label>
                </div>
                    ...
                    <?php 
                      ...
                      while($user = $users->fetch_assoc()) :?>
                          <tr>
                            <td>
                              <div class="d-flex px-2 py-1">
                                <div class="d-flex align-items-center">
                                  <img style="object-fit: cover;" src="/uploads/avatar/<?= $user['avatar']  ?>" class="avatar avatar-sm rounded-circle me-2" alt="user1">
                                </div>
                            ...
                            <td>
                              <p class="text-sm text-dark font-weight-semibold mb-0"><?= $user['role']  ?></p>
                              <p class="text-sm text-secondary mb-0">id: <?= $user['id']  ?></p>
                            </td>
                            <td class="align-middle text-center text-sm">
                              <span class="badge badge-sm border border-success text-success bg-success">Online</span>
                            </td>
                            <td class="align-middle text-center">
                              <span class="text-secondary text-sm font-weight-normal"><?= $user['created']  ?></span>
                            </td>

                            <td class="align-middle">
                            <!-- DELETE button -->
                               <a href="/admin/modules/users/delete.php?id=<?= $user['id'] ?>" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Delete user">
                                <svg width="14" height="14" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                                  <g><g>
                                    <path d="M284.286,256.002L506.143,34.144c7.811-7.811,7.811-20.475,0-28.285c-7.811-7.81-20.475-7.811-28.285,0L256,227.717
                                      ...
                                      L284.286,256.002z"/> </g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
                                  </svg>
                                </a>
                            ...
                            <!-- Button trigger modal Edit user -->
                              <a type="button" class="text-secondary font-weight-bold text-xs" 
                               data-bs-toggle="modal" data-bs-target="#users_edit_modal" id="users_edit_modal_id" 
                               data-bs-title="Edit user" data-user_id="<?$user['id'];?>" 
                               onclick="editUserToModalInput (
                                        '<?php echo $user['id'];?>', 
                                        '<?php echo $user['email'];?>', 

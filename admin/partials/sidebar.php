<?php 
  // Исключить попадание в админку незарегистрированному пользователю
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href="/admin/index.php" >
        <span class="font-weight-bold text-lg">Aranoz</span>
      </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link mt-2" href="/admin/pages/tables.php">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
              <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>table</title>
        ...
        <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=users">
          <span class="nav-link-text ms-1">Users</span>
        </a>
      </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=products">
          <span class="nav-link-text ms-1">Products</span>
        </a>
      <!-- </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=categories">
          <span class="nav-link-text ms-1">Categories</span>
        </a>
      </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=comments">
          <span class="nav-link-text ms-1">Comments</span>
        </a>
      </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=orders">
          <span class="nav-link-text ms-1">Orders</span>
        </a>
      </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=newsletters">
          <span class="nav-link-text ms-1">Newsletters</span>
        </a>
      </li>
      <li class="nav-item border-start my-1 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/admin/pages/page.php?page=request">
...
<!-- PHP -->
          <?php 
            // Если зарегистрирован, показать LogOut
            if(isLogin()): ?>
            <li class="nav-item border-start my-0 pt-2">
              <a class="nav-link position-relative ms-0 ps-2 py-2 " href="/php_scripts/logout.php">
